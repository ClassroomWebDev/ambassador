    ...
    <div className="flex min-h-screen flex-col justify-between bg-[#FAFAFA] font-sans text-slate-900">
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#991B1B] text-lg font-bold text-white shadow-sm">
              CA
            </div>
            <div>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 text-center sm:px-6 md:py-24 lg:px-8">
          <div className="mb-6 inline-flex items-center space-x-2 rounded-full border border-red-100 bg-red-50 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#991B1B]">
          ...
          <Link
            to="/auth"
            className="group inline-flex w-full items-center justify-center rounded-xl bg-[#991B1B] px-6 py-3.5 font-semibold text-white shadow-md transition hover:bg-red-800 sm:w-auto"
          >
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              {testimonials.map((t) => (
                <figure key={t.id} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  <Quote className="h-5 w-5 text-[#991B1B]" />
